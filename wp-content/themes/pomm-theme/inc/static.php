...
function masterScripts() {
  ...
  if( is_front_page() ) {
    wp_enqueue_script( 'wowslider-script', get_template_directory_uri().'/src/thirty/js/wowslider.js', array('jquery'), null, true );
    wp_enqueue_script( 'wowtransition-script', get_template_directory_uri().'/src/thirty/js/wowtransition.js', array('jquery'), $param, true );
  }
}
